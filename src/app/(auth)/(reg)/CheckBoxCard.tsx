...
const CheckBoxCard = ({checked, onChangeAction} : CheckboxNoCardProps) => {
    return (
        <div className="flex items-center gap-2">
            <label htmlFor="checkbox" className="inline-flex items-center cursor-pointer">
                <input 
                    type="checkbox" 
                    id="hasCard" 
                    checked={checked}
                ...
                />
                <span className={`relative w-5 h-5 border rounded flex items-center
                    justify-center duration-300 ${checked 
