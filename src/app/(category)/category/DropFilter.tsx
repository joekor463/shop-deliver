  ...
  return (
    <div className="xl:hidden">
      <button
        ...
        className="ml-3 xl:hidden h-8 p-2 w-32 rounded text-xs flex justify-center items-center duration-300 gap-x-2 bg-(--color-primary) text-white hover:shadow-(--shadow-button-default) active:shadow-(--shadow-button-active) cursor-pointer"
      >
        Фильтр
      </button>
      <div
