      ...
      <div className="flex flex-col mb-4 md:mb-8 xl:mb-10 justify-between text-[#414141]">
        <div className="flex flex-col gap-4 md:w-[737px] xl:w-full mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center xl:w-auto ">
            ...
            <button className="text-left flex flex-row pt-5 pl-5 rounded bg-[#FCD5BA] 
            w-full  max-w-[336px]  md:max-w-[352px] xl:max-w-[584px] h-[170px] xl:h-50 hover:shadow-(--shadow-card-shop) duration-300 relative overflow-hidden cursor-pointer">
