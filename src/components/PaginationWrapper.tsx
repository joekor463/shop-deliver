...
function getItemPerPageByWidth (contentType?: string) {
...
const PaginationWrapper = ({totalItems, currentPage, basePath, contentType
    }: {
        totalItems: number
        currentPage: number
        basePath: string
        ...
        useEffect(() => {
            const updateItemsPerPage = () => {
                const newItemsPerPage = getItemPerPageByWidth(contentType)
